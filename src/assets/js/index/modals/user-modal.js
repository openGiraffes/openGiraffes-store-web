...
userModal.controller.addEventListener('modal:show', () => {
  ...
  const username = localStorage.getItem('webstore-opengiraffes-username');
  if (username !== null) {
  ...
  const logintoken = localStorage.getItem('webstore-opengiraffes-logintoken')
  if (logintoken !== null) {
...
userModal.content.saveLoginCheckbox.onchange = (e) => {
  if (e.target.checked) {
    localStorage.setItem('webstore-opengiraffes-username', userModal.content.usernameInput.value);
    localStorage.setItem('webstore-opengiraffes-logintoken', userModal.content.logintokenInput.value);
  } else {
    localStorage.removeItem('webstore-opengiraffes-username');
    localStorage.removeItem('webstore-opengiraffes-logintoken');
  }
}